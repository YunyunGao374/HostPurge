...
# Plot
![image](FigureS2-Memory-RiceSiBa.jpeg)

Example-FigureS2-RiceSiBa

![image](FigureS2-Memory-HumanSiBa.jpeg)

Example-FigureS2-Memory-HumanSiBa
...
ggplot(data2, aes(x = Software, y = Gigabytes, fill = factor(Size))) +
  geom_bar(stat = "identity", position = position_dodge(width = 0.5), width = 0.5) +
  facet_grid(. ~ `HostGenomeProportion`) +  # Separate by HostGenomeProportion
  labs(
    x ="Software", y = "Memory Usage / Gigabytes", title = "Rice SiBa",
    fill = "Group"
  ) +
...
ggplot(data2, aes(x = Software, y = Gigabytes, fill = factor(Size))) +
  ...
  facet_grid(. ~ `HostGenomeProportion`) +  # Separate by HostGenomeProportion
  labs(
    x ="Software", y = "Memory Usage / Gigabytes", title = "Rice SyCo",
    fill = "Group"
  ) +
  scale_fill_manual(values = colors) +
  theme_classic()+
...
ggplot(data2, aes(x = Software, y = Gigabytes, fill = factor(Size))) +
  ...
  facet_grid(. ~ `HostGenomeProportion`) +  # Separate by HostGenomeProportion
  labs( 
    x ="Software", y = "Memory Usage / Gigabytes", title = "Human SiBa",
    fill = "Group"
  ) +
  scale_fill_manual(values = colors) +
  theme_classic()+
...
ggplot(data2, aes(x = Software, y = Gigabytes, fill = factor(Size))) +
  ...
  facet_grid(. ~ `HostGenomeProportion`) +  # Separate by HostGenomeProportion
  labs( 
    x ="Software", y = "Memory Usage / Gigabytes", title = "Human SyCo",
    fill = "Group"
  ) +
  scale_fill_manual(values = colors) +
  theme_classic()+
